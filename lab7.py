#bugged-multiplayer-battle-of-dices-dict
...
for i in range(number_of_players):
    ...
    player["email"] = input(f"What is the e-mail of Pkayer {i+1}?")
    player["country"] = input(f"What is the country of PLayer {i+1}?")

    players.append(player)

#cooler-multiuplayer-battle-of-dices-dict
...
#multiplayer-battle-of-dices-dict
